...
class Farmer extends Equatable {
  ...
  Farmer copyWith({
    ...
    int? householdNum,
    int? maleMembersNum,
    int? femaleMembersNum,
    String? motherMaidenName,
    String? personToNotify,
    String? ptnContact,
    String? ptnRelationship,
    DateTime? birthday,
  }) {
    return Farmer(
      id: id ?? this.id,
      ...
      house_hold_head: house_hold_head ?? this.house_hold_head,
      civilStatus: civilStatus ?? this.civilStatus,
      accountStatus: accountStatus ?? this.accountStatus,
      spouseName: spouseName ?? this.spouseName,
      religion: religion ?? this.religion,
      userId: userId ?? this.userId,
      householdNum: householdNum ?? this.householdNum,
      maleMembersNum: maleMembersNum ?? this.maleMembersNum,
      femaleMembersNum: femaleMembersNum ?? this.femaleMembersNum,
      motherMaidenName: motherMaidenName ?? this.motherMaidenName,
      personToNotify: personToNotify ?? this.personToNotify,
      ptnContact: ptnContact ?? this.ptnContact,
      ptnRelationship: ptnRelationship ?? this.ptnRelationship,

...
import 'package:flareline/pages/yields/yield_profile/yield_profile_form2.dart';
...
class YieldProfile2 extends LayoutWidget {
  const YieldProfile2({super.key, required this.yieldData});
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                YieldProfileForm2(yieldData: currentYieldData),
              ],
            ),
          ),
        );

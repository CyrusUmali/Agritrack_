...
import 'package:flareline/services/invoice_service.dart';
...
class _InvoiceContentState extends State<InvoiceContent> {
  ...
  Future<void> fetchData() async {
    final data = await _invoiceService.fetchInvoiceData();
    setState(() {
      _response = data;
    });
  }
                ...
                children: [
                  const Row(
                    children: [
                      ...
                      Expanded(
                          child: Text('\$120.00', textAlign: TextAlign.end)),
                    ],
                  ),
                  const SizedBox(
                    height: 12,
                  ...
                  const Row(
                    children: [
                      ...
                      Expanded(
                          child: Text('(+) \$10.00', textAlign: TextAlign.end)),
                    ],
                  ),
                  const SizedBox(
                    height: 12,
